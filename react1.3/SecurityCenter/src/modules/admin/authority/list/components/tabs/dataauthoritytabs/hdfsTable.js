...
import SeeHdfsPolicy from './pops/SeeHdfsPolicy'
  ...
  render() {
    ...
    return (<div style={{paddingBottom:'20px'}}>
      ...
      <div className="module-table">
        <DataTable data={this.state.data} column={this.getColumns()} howRow={AdminEnum.PAGE_SIZE} onPageChange={that.onPageChange.bind(this)} showPage="true"/>
      </div>
      <SeeHdfsPolicy ref="modal" data={this.formData}/>
