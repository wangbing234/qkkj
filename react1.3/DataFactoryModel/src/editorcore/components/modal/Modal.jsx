...
const Modal = React.createClass({
  ...
  close() {
    ...
    this.props.closeHander(this.props.node);
  },
  ...
  renderFooter(){
    ...
    if (this.props.showFooter) {
      if(this.props.okButton!="1")
      {
        okButtonForm=<button type="button" className="btn btn-primary" onClick={this.okHandler}>{this.props.okTitle}</button>;
      }
      return (
