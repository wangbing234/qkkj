...
import 'bfd-ui/lib/DataTable/main.less'
                ...
                rows.length > 0 ?
                    rows.map((item, j) => {
                        ...
                        const checkboxTd = this.props.onCheckboxSelect
                            ? <td><Checkbox disabled={isDisabled} checked={isSelect} onClick={this.handleCheckboxClick.bind(this)} onChange={this.handleCheckboxChange.bind(this, item)}></Checkbox></td>
                            : null
                        return (
...
class DataTable extends Component {
    ...
    render() {
        ...
        //this.state.items.totalList=this.props.data.totalList;
        ...
        const checkboxTh = this.props.onCheckboxSelect ? <th><Checkbox checked={this.state.isSelectAll} onChange={this.handleCheckboxAllChange.bind(this)}></Checkbox></th> : null
        return (
            <div>
