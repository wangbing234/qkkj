...
const Tabs = React.createClass({
  ...
  componentDidMount() {
    ...
    if (document.body.style['-webkit-mask-repeat'] !== void 0) {
      document.getElementsByClassName('bdos-tabs-shell')[0].className = "cssmasks";
    } else {
      document.getElementsByClassName('bdos-tabs-shell')[0].className = "no-cssmasks";
    }
  },
  ...
  render() {
    ...
    const cxIcon = classNames('bdos-tabs-shell', className)
    return (
