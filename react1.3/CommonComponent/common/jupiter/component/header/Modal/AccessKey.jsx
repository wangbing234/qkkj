...
class AccessKey extends React.Component {
   ...
   */
  getTableData() {
    this.ajaxGetAccessKey = Model.getAccessKey({}, (result)=> {
  ...
  renderTable() {
    return (
      <div>
        ...
        <Icon type="plus" style={{cursor:'pointer',marginBottom: 10}} onClick={this.addSecret.bind(this)}>
