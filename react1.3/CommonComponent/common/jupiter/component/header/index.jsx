...
class GlobalNav extends React.Component {
  ...
  componentDidMount() {
    //获取当前登录的用户信息
    this.ajaxGetUserAllInfo = Model.getUserAllInfo(result=> {
      console.info("获取当前用户信息成功:", result)
      this.setState({userinfo: result.data})
    })
  }

  componentWillUnmount() {
    this.ajaxGetUserAllInfo.abort();
  }
        ...
        <div className="bdos-header-right">
          ...
          <Dropdown ref="dropdown">
            ...
            <DropdownMenu>
              ...
              <li onClick={this.handleLogout.bind(this)}>退出</li>
            </DropdownMenu>
          </Dropdown>
        </div>
