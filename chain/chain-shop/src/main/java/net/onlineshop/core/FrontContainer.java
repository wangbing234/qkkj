...
//	public static final String myCart = "myCart";// 用户购物车key
	public static final String gzid = "gzid";// 渠道ID
	public static final String orderFrom = "orderFrom";// 渠道ID
	...
	public static final String DEF_ADDR = "def_addr";// 默认省份CODE
	public static final String DEF_AREA = "def_area";// 默认区域
