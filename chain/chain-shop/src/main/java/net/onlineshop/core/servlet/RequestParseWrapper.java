...
import org.apache.struts2.dispatcher.multipart.JakartaStreamMultiPartRequest;
 ...
 *
 */
public class RequestParseWrapper extends JakartaStreamMultiPartRequest {
	...
	public void parse(HttpServletRequest request, String saveDir) throws IOException {
		...
		request.getParameter("e.name");
		log.info(request + "," + saveDir + ",image=" + image);
