...
public class CommUtil {
	 ...
	 * @throws IOException
	 */
	public static Map<String, Object> saveFileToServer(HttpServletRequest request, String filePath, String saveFilePathName, String saveFileName, String[] extendes) throws IOException {
	 ...
	 * <li><span>首页</span></li>
	 * <li><span>上一页</span></li>
	 * <li><a class="demo" href ="/admin/index.php?act=member&amp;op=member&amp;curpage=2"><span>下一页</ span></a></li>
	 * <li><a class="demo" href="/admin/index.php?act=member&amp;op=member&amp;curpage=2" ><span>末页</span></a></li>
	 * 
	 * @param url
	 * @param params
	 * @param currentPage
	 ...
	 * @return
	 */
	public static String showPageHtml2(String url, String params, int currentPage, int pages) {
		String s = "<div class='pagination'><ul>";
		if (pages <= 1) {
			s += "<li><span>首页</span></li>";
			s += "<li><span>上一页</span></li>";
			s += "<li><span>下一页</span></li>";
			s += "<li><span>末页</span></li>";

		} else if (pages > 1) {
			if (currentPage == 1) {
				s += "<li><span>首页</span></li></li>";
				s += "<li><span>上一页</span></li></li>";
				s += "<li><a class='demo' href='" + url + "?currentPage=" + (currentPage + 1) + params + "'><span>下一页</span></a></li> ";
				s += "<li><a class='demo' href='" + url + "?currentPage=" + pages + params + "'><span>末页</span></a></li> ";
			} else if (currentPage > 1 && currentPage < pages) {
				s += "<li><a class='demo' href='" + url + "?currentPage=" + 1 + params + "'><span>首页</span></a></li> ";
				s += "<li><a class='demo' href='" + url + "?currentPage=" + (currentPage - 1) + params + "'><span>上一页</span></a></li> ";
				s += "<li><a class='demo' href='" + url + "?currentPage=" + (currentPage + 1) + params + "'><span>下一页</span></a></li> ";
				s += "<li><a class='demo' href='" + url + "?currentPage=" + pages + params + "'><span>末页</span></a></li> ";
	 ...
	 * <li><a class="demo" href=""><span>下一页</span></a></li>
	 * <li><a class="demo" href=""><span>末页</span></a></li>
	 * </ul>
	 * </div>
	 * 
	 * @param currentPage
	...
	public static String showPageFormHtml(int currentPage, int pages) {
		...
		if (pages <= 1) {
			...
			if (currentPage == 1) {
				s += "<li><span>首页</span></li></li>";
				s += "<li><span>上一页</span></li></li>";
				s += "<li><a class='demo' href='javascript:void(0);' onclick='return gotoPage(" + (currentPage + 1) + ")'><span>下一页</span></a></li> ";
				s += "<li><a class='demo' href='javascript:void(0);' onclick='return gotoPage(" + pages + ")'><span>末页</span></a></li> ";
			} else if (currentPage > 1 && currentPage < pages) {
				s += "<li><a class='demo' href='javascript:void(0);' onclick='return gotoPage(1)' ><span>首页</span></a></li> ";
				s += "<li><a class='demo' href='javascript:void(0);' onclick='return gotoPage(" + (currentPage + 1) + ")' ><span>上一页</span></a></li> ";
				s += "<li><a class='demo' href='javascript:void(0);' onclick='return gotoPage(" + (currentPage + 1) + ")' ><span>下一页</span></a></li> ";
				s += "<li><a class='demo' href='javascript:void(0);' onclick='return gotoPage(" + pages + ")' ><span>末页</span></a></li> ";
			} else if (currentPage == pages) {
				s += "<li><a class='demo' href='javascript:void(0);' onclick='return gotoPage(1)' ><span>首页</span></a></li> ";
