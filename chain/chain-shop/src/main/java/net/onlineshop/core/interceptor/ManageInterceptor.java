...
public class ManageInterceptor extends AbstractInterceptor {
	...
	public String intercept(ActionInvocation actionInvocation) throws Exception {
		...
		try {
			...
			session.setAttribute(ManageContainer.action_exception_error, StringUtils.isNotBlank(msg)?msg:"未知！");
			logger.debug("msg=" + msg);
			StringWriter sw = new StringWriter();
			e.printStackTrace(new PrintWriter(sw));
			session.setAttribute(ManageContainer.action_exception_stack_error, sw.getBuffer().toString());
		}
		return error;
	}
...
//			if ((actionName.equals("pay") && method.equals("toEdit")) || actionName.equals("oss") && method.equals("toEdit")) {
