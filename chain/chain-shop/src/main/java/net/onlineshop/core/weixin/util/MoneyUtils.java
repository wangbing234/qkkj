...
public class MoneyUtils {
	...
	public static String createSign(Map<String, Object> map) {
		...
		sb.append("key=" + WeixinUtils.partnerkey);
	...
	public static String getOrderNo() {
		String order = WeixinUtils.partner + new SimpleDateFormat("yyyyMMdd").format(new Date());
		Random r = new Random();
		for (int i = 0; i < 10; i++) {
			order += r.nextInt(9);
		}
	...
	final static String KEYSTORE_PASSWORD = WeixinUtils.partner;
