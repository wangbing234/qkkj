...
public class ImageUtils {
	 ...
	 * 
	 *             Java中也同样是这样。 但java提供了4个缩放的微调选项。 image.SCALE_SMOOTH //平滑优先 image.SCALE_FAST//速度优先 image.SCALE_AREA_AVERAGING //区域均值 image.SCALE_REPLICATE //像素复制型缩放 image.SCALE_DEFAULT //默认缩放模式
	 * 
	 *             调用方法 Image new_img=old_img.getScaledInstance(1024, 768, Image.SCALE_SMOOTH);
	 */
