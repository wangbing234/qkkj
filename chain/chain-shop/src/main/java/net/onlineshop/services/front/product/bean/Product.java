 ...
 * 
 */
public class Product extends net.onlineshop.services.common.Product implements Serializable {
	...
	private List<Integer> queryAttrIDs;// 查询属性集合
	private String[] keywordList;// 关键字集合
	...
	private List<Attribute> paraList;// 商品参数集合
	...
	private List<Spec> specColor;// 颜色
	private Set<String> specSize = new TreeSet<String>();// 尺寸
	...
	public List<Integer> getQueryAttrIDs() {
		if (queryAttrIDs == null) {
			this.queryAttrIDs = new LinkedList<Integer>();
		}
		return queryAttrIDs;
	}

	public void setQueryAttrIDs(List<Integer> queryAttrIDs) {
		this.queryAttrIDs = queryAttrIDs;
	}
	...
	public List<Spec> getSpecColor() {
		return specColor;
	}

	public void setSpecColor(List<Spec> specColor) {
	...
	public String[] getKeywordList() {
		...
		if (keywords != null && !"".equals(keywords)) {
			keywordList = keywords.replaceAll("，", ",").split(",");
		}
		return keywordList;
	}
	...
	public List<Attribute> getParaList() {
		return paraList;
	}

	public void setParaList(List<Attribute> paraList) {
	...
	public String getCatalogName() {
		int productType= this.getProductType();
		catalogName=SystemParms.getCatalogName(productType+"");
		return catalogName;
	}
	...
	public Boolean getFavoriteed() {
		return favoriteed;
	}

	public void setFavoriteed(Boolean favoriteed) {
		this.favoriteed = favoriteed;
	}
