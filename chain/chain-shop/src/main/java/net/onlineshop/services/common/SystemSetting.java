...
public class SystemSetting extends PagerModel implements Serializable {
	...
	private String membersRates;// 会员折扣
	private float sysRates;//
	private String rechargeRates;// 充值比例
	...
	public String getIcpz() {
		return icpz;
	}

	public void setIcpz(String icpz) {
		this.icpz = icpz;
	}

	public String getMembersRates() {
		return membersRates;
	}

	public void setMembersRates(String membersRates) {
		this.membersRates = membersRates;
	}

	public float getSysRates() {
		return sysRates;
	}

	public void setSysRates(float sysRates) {
		this.sysRates = sysRates;
	}
