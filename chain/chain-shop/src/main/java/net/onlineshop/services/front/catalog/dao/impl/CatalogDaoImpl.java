package net.onlineshop.services.front.catalog.dao.impl;
...
import net.onlineshop.services.front.catalog.dao.CatalogDao;
...
public class CatalogDaoImpl implements CatalogDao {
	...
	public PagerModel selectPageList(Catalog e) {
		return dao.selectPageList("front.catalog.selectPageList", "front.catalog.selectPageCount", e);
	}
