...
public class OrdersReport {
	...
	public String toString() {
		return "OrdersReport [cancelCount=" + cancelCount + ", notPayCount=" + notPayCount + ", payButNotPassCount=" + payButNotPassCount + ", waitSendGoodsCount=" + waitSendGoodsCount + ", WAIT_SELLER_AGREE=" + WAIT_SELLER_AGREE + ", SELLER_REFUSE_BUYER=" + SELLER_REFUSE_BUYER + ", WAIT_BUYER_RETURN_GOODS=" + WAIT_BUYER_RETURN_GOODS + ", WAIT_SELLER_CONFIRM_GOODS=" + WAIT_SELLER_CONFIRM_GOODS
				+ ", outOfStockProductCount=" + outOfStockProductCount + ", notReplyCommentCount=" + notReplyCommentCount + ", orderWaitAuditingCount=" + orderWaitAuditingCount + "]";
	}
