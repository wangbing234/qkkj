...
public class BaZi {
	 ...
	 * 六十甲子
	 */
	public static final String[] jiazhi = { "甲子", "乙丑", "丙寅", "丁卯", "戊辰", "己巳", "庚午", "辛未", "壬申", "癸酉", "甲戌", "乙亥", "丙子", "丁丑", "戊寅", "己卯", "庚辰", "辛巳", "壬午", "癸未", "甲申", "乙酉", "丙戌", "丁亥", "戊子", "己丑", "庚寅", "辛卯", "壬辰", "癸巳", "甲午", "乙未", "丙申", "丁酉", "戊戌", "己亥", "庚子", "辛丑", "壬寅", "癸卯", "甲辰", "乙巳", "丙午", "丁未", "戊申", "己酉", "庚戌", "辛亥", "壬子", "癸丑", "甲寅", "乙卯", "丙辰", "丁巳", "戊午", "己未", "庚申", "辛酉", "壬戌",
			"癸亥" };
	private Calendar cal;

	/**
	 * @param hour
	 *            这里的时间范围是1-12，具体几点到几点是子时、丑时请参考相关文档 具体的选择如下 "子：1", "丑：2", "寅：3", "卯：4", "辰：5", "巳：6", "午：7", "未：8", "申：9", "酉：10", "戌：11", "亥：12"
	 * @author kongqz
	 */
	...
	/**
	 * 针对一个在西元 1983-01-10 中午12：30生的人的计算。 这里12点半在中国的古代历书中算是午时 子时24.00－2.00,丑时2.00－4.00,寅时4.00－6.00,卯时6.00－8.00, 辰时8.00－10.00,巳时10.00－12.00,午时12.00－14.00,未时14.00－16.00
	...
	public static void main(String[] args) {
		...
		try {
			...
			cal.setTime(sdf.parse("1986-01-26"));
