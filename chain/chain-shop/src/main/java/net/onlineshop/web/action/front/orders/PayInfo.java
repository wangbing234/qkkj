...
public class PayInfo {
	...
	public String toString() {
		return "PayInfo [WIDseller_email=" + WIDseller_email + ", WIDout_trade_no=" + WIDout_trade_no + ", WIDsubject=" + WIDsubject + ", WIDprice=" + WIDprice + ", WIDbody=" + WIDbody + ", WIDreceive_name=" + WIDreceive_name + ", WIDreceive_address=" + WIDreceive_address + ", WIDreceive_zip=" + WIDreceive_zip + ", WIDreceive_phone=" + WIDreceive_phone + ", WIDreceive_mobile=" + WIDreceive_mobile
				+ ", logistics_fee=" + logistics_fee + ", logistics_type=" + logistics_type + ", show_url=" + show_url + "]";
	}
