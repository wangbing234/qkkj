...
<body>
	<s:form action="navigation" namespace="/manage" method="post"
		theme="simple">
		<table class="table table-bordered">
			<tr>
				<td colspan="6">
					...
					<button method="navigation!selectList.action"
					...
					<button method="navigation!deletes.action" class="btn btn-danger"
		...
		<div class="alert alert-info"
			style="margin-bottom: 2px; text-align: left;">友情链接会自动显示到门户的最底部。友情链接的地址不要以“http://”开头。</div>
		<table class="table table-bordered table-hover">
			...
			<s:iterator value="pager.list">
				<tr>
					...
					<td>&nbsp;<a href="http://<s:property value="http"/>"
