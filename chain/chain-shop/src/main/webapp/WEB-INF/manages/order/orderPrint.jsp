			...
			<div class="span12">
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<th nowrap="nowrap">商品金额</th>
						<th nowrap="nowrap"><s:property value="e.ptotal" /></th>
					...
					<tr>
						...
						<td nowrap="nowrap" colspan="21"><%=SystemManager.systemSetting.getName() %>
							(<%=SystemManager.systemSetting.getWww() %>)</td>
					</tr>
					<tr>
						<th nowrap="nowrap">收货人</th>
						<td colspan="21"><s:property value="e.ordership.province" />,
							<s:property value="e.ordership.city" />, <s:property
								value="e.ordership.area" />, <s:property
								value="e.ordership.shipaddress" />, <s:property
								value="e.ordership.shipname" />(收)</td>
					</tr>
					...
					<s:iterator value="e.orderdetail" status="i" var="odetail">
						<tr>
							...
							<td colspan="2" width="400px"><s:property
									value="productName" />[${specInfo }]</td>
