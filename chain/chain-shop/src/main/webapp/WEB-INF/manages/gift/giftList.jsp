...
<body>
	<s:form action="gift" namespace="/manage" method="post" theme="simple"
		id="form" name="form">
		...
		<table class="table table-bordered">
			<tr>
				...
				<td><s:select cssStyle="width:100px;"
						list="#{'':'','up':'可用','down':'不可用'}" name="e.status" id="status"
			...
			<tr>
				<td colspan="16">
					<button method="gift!selectList.action" class="btn btn-primary"
					...
					<button method="gift!deletes.action" class="btn btn-danger"
					...
					<div
						...
						<%@ include file="/WEB-INF/manages/system/giftPager.jsp"%>
					</div>
				</td>
			</tr>
		</table>
		...
		<table class="table table-bordered table-hover">
			...
			<s:iterator value="pager.list">
				<tr>
					...
					<td><s:a href="gift!toEdit.action?e.id=%{id}">编辑</s:a></td>
				</tr>
			</s:iterator>

			<tr>
				<td colspan="17" style="text-align: center; font-size: 12px;"><%@ include
						file="/WEB-INF/manages/system/giftPager.jsp"%></td>
			</tr>
		</table>
