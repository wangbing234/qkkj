...
<body>
	<s:form action="oss" namespace="/manage" theme="simple" id="form"
		name="form">
		<table class="table table-bordered">
			<tr style="background-color: #dff0d8">
				<td colspan="2"
					style="background-color: #dff0d8; text-align: center;"><strong>存储编辑</strong>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="text-align: left;"><s:select
						list="#{'aliyun':'阿里云存储'}" name="e.code" /></td>
			</tr>
			<!-- 			<tr> -->
			...
			<tr>
				...
				<td style="text-align: left;"><s:textfield
						name="e.aliyunOSS.ACCESS_ID" id="ACCESS_ID"
						data-rule="ACCESS_ID:required;ACCESS_ID;length[1~50];" /></td>
			</tr>
			<tr>
				<td style="text-align: right;">ACCESS_KEY</td>
				<td style="text-align: left;"><s:textfield
						name="e.aliyunOSS.ACCESS_KEY" id="ACCESS_KEY"
						data-rule="ACCESS_KEY:required;ACCESS_KEY;length[1~50];" /></td>
			</tr>
			<tr>
				<td style="text-align: right;">OSS_ENDPOINT</td>
				<td style="text-align: left;"><s:textfield
						name="e.aliyunOSS.OSS_ENDPOINT" id="OSS_ENDPOINT"
						data-rule="OSS_ENDPOINT:required;OSS_ENDPOINT;length[1~50];" /></td>
			</tr>
			<tr>
				<td style="text-align: right;">bucketName</td>
				<td style="text-align: left;"><s:textfield
						name="e.aliyunOSS.bucketName" id="bucketName"
						data-rule="bucketName:required;bucketName;length[1~50];" /></td>
			</tr>
			<tr>
				<td style="text-align: right;">状态</td>
				<td style="text-align: left;">
					<%-- <s:select list="#{'y':'启用'}" name="e.status"/> --%> <s:select
						list="#{'y':'启用','n':'禁用'}" name="e.status" />
				</td>
			</tr>
			<tr>
