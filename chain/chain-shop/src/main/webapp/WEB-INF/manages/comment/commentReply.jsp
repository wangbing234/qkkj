	...
	<s:form action="comment" namespace="/manage" theme="simple" name="form"
		...
		<table id="result_table" class="table table-bordered"
			...
			<tr style="background-color: #dff0d8">
				<td colspan="2"
					style="background-color: #dff0d8; text-align: center;"><strong>回复评论</strong>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="text-align: left;"><s:textarea name="e.reply"
						id="reply" style="width:100%;height:400px;visibility:hidden;"
						data-rule="回复内容:required;reply;length[5~3000];"></s:textarea></td>
			</tr>
			<tr>
