...
<body>
	<s:form action="task!selectList" namespace="/manage" method="post"
		theme="simple">
		<table class="table table-bordered">
			<tr>
				<td colspan="28"><s:submit method="selectList" value="查询"
		...
		<table class="table table-bordered table-hover">
			...
			<s:iterator value="pager.list">
				<tr>
					...
					<td nowrap="nowrap">&nbsp;<s:property value="code" /> <br>
					...
					<td nowrap="nowrap"><s:if
							test="currentStatus.equals(\"wait\") or currentStatus.equals(\"stop\")">
							<s:a target="_blank" href="task!startTask.action?e.code=%{code}">立即执行</s:a>
						</s:if> <s:elseif test="currentStatus.equals(\"run\")">
