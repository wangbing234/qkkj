...
<body>
	<s:form action="accounts!updateFreeze.action" namespace="/manage"
		theme="simple" id="form">
		<table class="table table-bordered">
			...
			<tr>
				...
				<td style="text-align: left;"><s:select
						list="#{'y':'是','n':'否'}" id="freeze" name="e.freeze"
						listKey="key" listValue="value" /></td>
			</tr>
			<tr>
				<td width="200px" style="text-align: right;">冻结时间范围</td>
				<td><input id="d4311" class="Wdate search-query input-small"
					type="text" name="e.freezeStartdate"
					value="<s:property value="e.freezeStartdate" />"
					onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'d4312\')||\'2020-10-01\'}'})" />
					~ <input id="d4312" class="Wdate search-query input-small"
					type="text" name="e.freezeEnddate"
			...
			<tr>
				<td colspan="2" style="text-align: center;">
					...
					<button method="accounts!updateFreeze.action"
