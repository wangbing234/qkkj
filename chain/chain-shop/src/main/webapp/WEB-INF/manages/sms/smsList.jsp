...
<body>
	<s:form action="sms!selectList" namespace="/manage" method="post"
		theme="simple">
		<table class="table table-bordered">
			<tr>
				<td style="text-align: right;" nowrap="nowrap">手机号码</td>
				<td style="text-align: left;"><s:textfield name="e.phone"
						cssClass="search-query input-small" id="phone" /></td>
			</tr>
			<tr>
				<td colspan="8"><s:submit method="selectList" value="查询"
		...
		<table class="table table-bordered table-hover">
			...
			<s:iterator value="pager.list">
				<tr>
					...
					<td nowrap="nowrap"><s:if test="e.returnCode<=0">
