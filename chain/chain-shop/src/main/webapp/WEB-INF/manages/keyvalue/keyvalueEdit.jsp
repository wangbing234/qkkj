...
<body>
	<s:form action="keyvalue" namespace="/manage" theme="simple" id="form"
		name="form">
		<table class="table table-bordered">
			<tr style="background-color: #dff0d8">
				<td colspan="2"
					style="background-color: #dff0d8; text-align: center;"><strong>键值对编辑</strong>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="text-align: left;"><s:textfield name="e.key1"
						data-rule="键:required;key1;length[1~45];" id="key1" /></td>
			</tr>
			<tr>
				<td style="text-align: right;">值</td>
				<td style="text-align: left;"><s:textfield name="e.value"
						data-rule="值:required;value;length[1~45];" id="value" /></td>
			</tr>
			<tr>
