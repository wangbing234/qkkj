...
<body>
	...
	<s:form action="advert" namespace="/manage" theme="simple" name="form1">
		<table class="table table-bordered" style="width: 95%; margin: auto;">
			...
			<tr style="background-color: #dff0d8">
				<td colspan="2"
					style="background-color: #dff0d8; text-align: center;"><strong>广告内容编辑
				</strong></td>
			</tr>
			...
			<tr>
				...
				<td style="text-align: left;"><s:select
						list="#{'y':'启用','n':'禁用'}" name="e.status" id="status"
						listKey="key" listValue="value" /></td>
			</tr>
			<tr>
				<td style="text-align: right;">是否优先使用图集</td>
				<td style="text-align: left;"><s:select
						list="#{'y':'优先','n':'不优先'}" name="e.useImagesRandom"
						id="useImagesRandom" listKey="key" listValue="value" /></td>
			</tr>
			<tr>
				...
				<td style="text-align: left;"><input id="d4311"
					...
					~ <input id="d4312" class="Wdate search-query" type="text"
					name="e.enddate" value="<s:property value="e.enddate" />"
					onFocus="WdatePicker({minDate:'#F{$dp.$D(\'d4311\')}',maxDate:'2020-10-01'})" />
				</td>
			</tr>
			<tr>
				<td style="text-align: right;">内容</td>
				<td style="text-align: left;"><s:textarea name="e.html"
						style="width:100%;height:300px;visibility:hidden;"></s:textarea></td>
			</tr>
		</table>
	</s:form>
	...
	<script charset="utf-8"
		src="<%=request.getContextPath() %>/resource/kindeditor-4.1.7/kindeditor-all.js"></script>
	<script charset="utf-8"
	...
	KindEditor.ready(function(K) {
		editor = K.create('textarea[name="e.html"]', {
		  uploadJson : '/resource/kindeditor-4.1.7/jsp/upload_json.jsp',
		fileManagerJson : '/resource/kindeditor-4.1.7/jsp/file_manager_json.jsp',
