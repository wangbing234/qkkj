	...
	<s:form action="systemlog" namespace="/manage" theme="simple">
		<table class="table table-bordered">
			<tr style="background-color: #dff0d8">
				<td colspan="2"
					style="background-color: #dff0d8; text-align: center;"><strong>系统日志编辑</strong>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="text-align: left;"><s:select
						list="#{0:'--全部--',1:'登陆日志',2:'版本日志'}" name="e.type" id="type"
						listKey="key" listValue="value" /></td>
			</tr>
			<tr>
				<td style="text-align: right;">内容</td>
				<td style="text-align: left;"><s:textarea name="e.content"
						style="width:100%;height:250px;visibility:hidden;"></s:textarea></td>
			</tr>
			<tr>
				<td colspan="2" style="text-align: center;"><s:if
						test="e.id=='' or e.id==null">
						<s:submit method="insert" onclick="return onSubmit();" value="新增"
							cssClass="btn btn-primary" />
					</s:if> <s:else>
						<s:submit method="update" onclick="return onSubmit();" value="保存"
							cssClass="btn btn-primary" />
					</s:else> <s:submit method="back" value="返回" cssClass="btn btn-inverse" /></td>
			</tr>
		</table>
	</s:form>
