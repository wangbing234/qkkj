...
<body style="font-size: 12px;">
	<s:form action="systemlog" namespace="/manage" method="post"
		theme="simple">
		<table class="table table-bordered">
			<tr>
				...
				<td style="text-align: left;"><s:select
						list="#{'y':'是','n':'否'}" name="e.diffAreaLogin"
						id="diffAreaLogin" listKey="key" listValue="value" headerKey=""
						headerValue="" /></td> -->
				<td>登录IP</td>
				<td><s:textfield cssClass="input-medium search-query"
						name="e.loginIP" /></td>
		...
		<table class="table table-bordered">
			<tr>
				<td colspan="16">
					...
					<button method="systemlog!selectList.action"
					...
					<div
						...
						<%@ include file="/WEB-INF/manages/systemlog/logPager.jsp"%>
					</div> <%-- 							<s:submit method="toAdd" value="添加" cssClass="btn btn-success" /> --%>
		...
		<table class="table table-bordered">
			...
			<s:iterator value="pager.list">
				<tr>
					...
					<%-- <td>&nbsp; <s:if test="diffAreaLogin.equals(\"y\")">是</s:if>
					</td>--%>
			</s:iterator>

			<tr>
				<td colspan="17" style="text-align: center;"><%@ include
						file="/WEB-INF/manages/systemlog/logPager.jsp"%></td>
			</tr>
		</table>
	</s:form>
</body>
