...
<body style="background-color: #FFF; text-align: center; margin: auto;">
	<div class="container">
		...
		<div class="row">
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1" style="font-size: 14px;">十万火急</a> <!-- 						<a href="#"> -->
				...
				<div id="tabs-1">
					...
					<table class="table table-bordered">
						<tr>
							<td>等待发货订单数：<a class="Afont22" style="color: #f50;"
								href="/manage/order!selectList.action?init=y&paystatus=y&status=pass"><%=orderReport.getWaitSendGoodsCount()%></a></td>
							<!-- <td>截图确认待审核：<a class="Afont22" style="color: #f50;"
								href="/manage/order!selectList.action?&paystatus=y&status=sure"><%=orderReport.getPayButNotPassCount()%></a></td> -->
						</tr>
						<tr style="display:none">
							<td>已取消订单数：<a
								href="/manage/order!selectList.action?init=y&status=cancel"><%=orderReport.getCancelCount() %></a></td>
							<td  >货到付款待审核：<a 
								href="/manage/order!selectList.action?e.paystatus=n&e.status=init&e.payType=3"><%=orderReport.getOrderWaitAuditingCount()%></a></td>
						</tr>
					</table>
					...
					<table class="table table-bordered">
						<tr>
							<td>缺货商品数：<a class="Afont22" style="color: #f50;"
								href="/manage/product!selectList.action?init=y&selectOutOfStockProduct=true"><%=orderReport.getOutOfStockProductCount()%></a></td>
							<td  style="display: none">未回复的吐槽评论数：<a
								href="<%=SystemManager.systemSetting.getManageHttp()%>/manage/comment!selectList.action?init=y&selectCommentFromIndex=true"><%=orderReport.getNotReplyCommentCount()%></a></td>
						</tr>
					</table>
				</div>
				<div id="tabs-2">
					<table class="table table-condensed">
						...
						<tr>
							...
							<td style="text-align: left;"><%=ssInfo.getDescription() %>
							</td>
						</tr>
						<tr>
							<td style="text-align: right;">keywords:</td>
							<td style="text-align: left;"><%=ssInfo.getKeywords() %></td>
						</tr>
						<tr>
							<td style="text-align: right;">shortcuticon:</td>
							<td style="text-align: left;"><%=ssInfo.getShortcuticon() %>
							</td>
						</tr>
						<tr>
							<td style="text-align: right;">联系地址:</td>
							<td style="text-align: left;"><%=ssInfo.getAddress() %></td>
						</tr>
						<tr>
							<td style="text-align: right;">联系电话:</td>
							<td style="text-align: left;"><%=ssInfo.getTel() %></td>
						</tr>
						<tr>
							<td style="text-align: right;">邮箱:</td>
							<td style="text-align: left;"><%=ssInfo.getEmail() %></td>
						</tr>
						<tr>
							<td style="text-align: right;">备案号:</td>
							<td style="text-align: left;"><%=ssInfo.getIcp() %></td>
						</tr>
						<tr>
							<td style="text-align: right;">是否开放网站:</td>
							<td style="text-align: left;"><input type="checkbox"
								disabled="disabled" checked="<%=ssInfo.getIsopen() %>"
								value="<%=ssInfo.getIsopen() %>" /></td>
						</tr>
						<tr>
							<td style="text-align: right;">关闭信息:</td>
							<td style="text-align: left;"><%=ssInfo.getCloseMsg() %></td>
						</tr>
					</table>
				</div>
