...
<body>
	<s:form action="commentType" namespace="/manage" theme="simple"
		onsubmit="return onSubmit();">
		<table class="table table-bordered">
			<tr style="background-color: #dff0d8">
				<td colspan="2"
					style="background-color: #dff0d8; text-align: center;"><strong>评论插件编辑</strong>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="text-align: left;"><s:select
						list="#{'default':'系统默认','duoshuo':'多说评论插件'}" name="e.code" /></td>
			</tr>
			<tr>
