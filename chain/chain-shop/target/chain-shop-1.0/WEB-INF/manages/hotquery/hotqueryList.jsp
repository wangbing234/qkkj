...
<body>
	<s:form action="hotquery" namespace="/manage" method="post"
		theme="simple" id="form" name="form">
		...
		<table class="table table-bordered">
			<tr>
				<td colspan="16">
					<button method="hotquery!selectList.action" class="btn btn-primary"
					...
					<button method="hotquery!deletes.action" class="btn btn-danger"
		...
		<table class="table table-bordered table-hover">
			...
			<s:iterator value="pager.list">
				<tr>
					...
					<td class="aCss"><s:a href="hotquery!toEdit.action?e.id=%{id}">
							<s:property value="key1" />
						</s:a></td>
					<td>&nbsp;<a target="_blank" href="<s:property value="url" />"><s:property
								value="url" /></a></td>
					<td><s:a href="hotquery!toEdit.action?e.id=%{id}">编辑</s:a></td>
				</tr>
			</s:iterator>
