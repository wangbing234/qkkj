...
<body>
	<s:form action="keyvalue" namespace="/manage" method="post"
		theme="simple">
		<table class="table table-bordered">
			<tr>
				<td style="text-align: right;">键</td>
				<td style="text-align: left;"><s:textfield name="e.key1" /></td>
				<td style="text-align: right;">值</td>
				<td style="text-align: left;"><s:textfield name="e.value" /></td>
			</tr>
			<tr>
				<td colspan="6">
					<%-- 							<s:submit method="selectList" value="查询" cssClass="btn btn-primary" /> --%>
					<button method="keyvalue!selectList.action" class="btn btn-primary"
					...
					<button method="keyvalue!deletes.action" class="btn btn-danger"
