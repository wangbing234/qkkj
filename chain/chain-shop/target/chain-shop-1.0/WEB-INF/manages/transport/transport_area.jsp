		...
		<div class="area_box_main">
			<ul>
				...
				<li><input name="province_$!{info.id}"
					id="province_$!{info.id}" type="checkbox" value="$info.id" /> <span><label
						for="province_${info.id}" style="float: left;">$!{info.areaName}</label><b
						id="city_count_$!{info.id}" style="color: #F60"></b></span>
					...
					<div class="area_level">
						<ul>
							...
							<li><label><input name="city_$!{info1.id}"
									...
									type="checkbox" value="$!{info1.id}" />$!info1.areaName</label></li> #end
