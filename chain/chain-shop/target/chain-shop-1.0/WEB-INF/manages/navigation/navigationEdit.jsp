...
<body>
	<s:form action="navigation" namespace="/manage" theme="simple"
		name="form" id="form">
		<table class="table table-bordered">
			<tr style="background-color: #dff0d8">
				<td colspan="2"
					style="background-color: #dff0d8; text-align: center;"><strong>导航菜单编辑</strong>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="text-align: left;"><s:textfield name="e.name"
						data-rule="名称:required;name;length[1~45];" id="name" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="text-align: left;"><s:textfield name="e.http"
						data-rule="名称:required;http;length[1~70];" id="http" /><br>
					(输入的地址不带http://)</td>
			</tr>
			<tr>
