...
<body>
	...
	<s:form action="gift" namespace="/manage" theme="simple" name="form"
		id="form">
		<%-- 		<s:hidden name="type"/> --%>
		...
		<table class="table table-bordered">
			...
			<tr style="background-color: #dff0d8">
				<td colspan="2"
					style="background-color: #dff0d8; text-align: center;"><strong>商品赠品编辑
				</strong></td>
			</tr>
			...
			<tr>
				...
				<td style="text-align: left;"><s:textfield name="e.giftName"
						style="width: 80%;" id="giftName"
						data-rule="赠品名称:required;giftName;length[1~100];" /></td>
			</tr>
			<tr>
				<td style="text-align: right; width: 80px;">赠品价值</td>
				<td style="text-align: left;"><s:textfield name="e.giftPrice"
						id="giftPrice" data-rule="赠品价格:required;giftPrice;length[1~100];" /></td>
			</tr>
			<tr>
				<td style="text-align: right; width: 80px;">状态</td>
				<td style="text-align: left;"><s:select name="e.status"
						id="status" list="#{'up':'已上架','down':'已下架'}"></s:select></td>
			</tr>
			<tr>
				<td style="text-align: right;">主图</td>
				<td style="text-align: left;" colspan="3"><input type="button"
					name="filemanager" value="浏览图片" class="btn btn-success" /> <s:textfield
						type="text" id="picture" name="e.picture" ccc="imagesInput"
						style="width: 600px;" data-rule="小图;required;picture;" /> <s:if
						test="e.picture!=null">
						<a target="_blank"
