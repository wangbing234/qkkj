...
<body>
	<table class="table table-bordered">
		<tr style="background-color: #dff0d8">
			<td colspan="2"
				style="background-color: #dff0d8; text-align: center;"><strong>商品赠品信息
			</strong></td>
		</tr>
		...
		<tr>
			...
			<td style="text-align: left;"><s:property value="e.giftName"
					escapeHtml="false" /></td>
		</tr>
		<tr>
			<td style="text-align: right; width: 80px;">赠品价值</td>
			<td style="text-align: left;"><s:property value="e.giftPrice"
					escapeHtml="false" /></td>
		</tr>
		<tr>
			<td style="text-align: right; width: 80px;">状态</td>
			<td style="text-align: left;"><s:if
					test="e.status.equals(\"up\")">已上架</s:if> <s:elseif
					test="e.status.equals(\"down\")">已下架</s:elseif></td>
		</tr>
		<tr>
			<td style="text-align: right;">主图</td>
			<td style="text-align: left;" colspan="3"><s:if
					test="e.picture!=null">
					<a target="_blank"
