		...
		<table class="table table-bordered">
			<tr>
				<td colspan="6"><s:submit method="selectList" value="查询"
						cssClass="btn btn-primary" /> <s:submit method="toAdd" value="添加"
						cssClass="btn btn-success" /> <s:submit method="deletes"
						onclick="return deleteSelect();" value="删除"
		...
		<table id="result_table" class="table table-bordered">
			...
			<s:iterator value="pager.list">
				<tr>
					...
					<td><s:a href="/manage/area!toEdit.action?e.id=%{id}">编辑</s:a></td>
				</tr>
			</s:iterator>
