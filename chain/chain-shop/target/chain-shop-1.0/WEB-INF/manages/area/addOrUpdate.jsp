...
<body style="text-align: center;">
	<s:form action="menu" name="form1" namespace="/manage" theme="simple">
		...
		<table id="result_table1" class="table table-bordered"
			...
			<tr>
				<td colspan="2"
					style="background-color: #dff0d8; text-align: center;"><strong>选中的项</strong>
				</td>
			</tr>
			<tr>
				<td>id</td>
				<td><input id="input_parent_id" readonly="readonly"
					value='<s:property value="e.id"/>' /></td>
			</tr>
			<tr>
				<td>code</td>
				<td><input id="input_parent_code" readonly="readonly"
					value='<s:property value="e.code"/>' /></td>
			</tr>
			<tr>
				<th>pcode</th>
				<td style="text-align: left;"><input id="input_parent_pcode"
					readonly="readonly" value='<s:property value="e.pcode"/>' /></td>
			</tr>
			<tr>
				<th>名称</th>
				<td style="text-align: left;"><input id="input_parent_name"
					size="80" value='<s:property value="e.name"/>' /></td>
			</tr>
		</table>
		<!-- item -->
		...
		<table class="table table-bordered"
			...
			<tr>
				<td colspan="2"
					style="background-color: #dff0d8; text-align: center;"><strong>子项</strong>
				</td>
			</tr>
			<tr style="display: none;">
				<td>id</td>
				<td><input id="input_children_id" readonly="readonly" /></td>
			</tr>
			<tr>
				<th>类型</th>
				<td style="text-align: left;"><s:select
						list="#{'children':'子项','top':'顶级'}" id="input_children_type"
						name="e.type" onchange="changeType()" cssClass="input-medium"
						listKey="key" listValue="value" /></td>
			</tr>
			<tr>
				<td>children_pcode</td>
				<td><input id="input_children_pcode" readonly="readonly"
					value='<s:property value="e.code"/>' /></td>
			</tr>
			<tr>
				<td>code</td>
				<td><input id="input_children_code" /></td>
			</tr>
			<tr>
				<th>名称</th>
				<td style="text-align: left;"><input id="input_children_name"
					size="60" /></td>
			</tr>
			<tr>
				<td style="text-align: center;" colspan="2"><input
					type="button" id="add" value="修改或添加" class="btn btn-primary" /></td>
			</tr>
		</table>
	</s:form>
</body>
