...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resource/RGraph2_2013-08-01-stable/libraries/RGraph.common.core.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resource/RGraph2_2013-08-01-stable/libraries/RGraph.common.effects.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resource/RGraph2_2013-08-01-stable/libraries/RGraph.common.key.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resource/RGraph2_2013-08-01-stable/libraries/RGraph.bar.js"></script>
<!--[if lt IE 9]><script src="../excanvas/excanvas.js"></script><![endif]-->
<script
	src="<%=request.getContextPath()%>/resource/RGraph2_2013-08-01-stable/libraries/jquery.min.js"></script>
...
<script type="text/javascript">
	$(function() {
		...
		*/
		...
		$.getJSON("<%=request.getContextPath()%>/manages/sessionCount!getChartData.action",function(result){
...
<body style="font-size: 12px;">
	<s:form action="sessionCount" namespace="/manage" method="post"
		theme="simple">
		...
		<div class="container">
			<div class="row">
				<div class="span12" style="border: 0px solid red;">
					<div class="row"></div>
					2013年按月统计：<br>
					<canvas id="bar" data-type="Bar" width="600" height="400"
						style="width: 600px; height: 400px;">[浏览器不支持HTML5，所以图表无法显示，请使用360极速、火狐、google等浏览器(非IE系列的)]</canvas>
				</div>
			</div>
		</div>
	</s:form>
