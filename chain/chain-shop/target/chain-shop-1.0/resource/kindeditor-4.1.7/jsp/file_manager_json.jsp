...
if(oss){
	...
	String rootPath = CoreParamCache.getInstance().get("productPath") + "attached/";
	//String rootPath = "D:\\workspace\\myshop\\web\\attached\\";//pageContext.getServletContext().getRealPath("/") + "attached/";
	//根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
	String rootUrl  = CoreParamCache.getInstance().get("productPath")+"attached/";//request.getContextPath() + "/attached/";
	//图片扩展名
