...
function FloatSideBar(){function b(b){var d=$(window).height();$(this).scrollTop()==0||$("#fancybox-overlay").is(":visible")?($("#top").hide(),b&&$("#floatCart").css("top",$(this).scrollTop()+d-380+"px")):b?($("#top").css("top",$(this).scrollTop()+d-220+"px").show(),$("#floatCart").css("top",$(this).scrollTop()+d-380+"px")):$("#top").show();$(document).scroll(function(){$("#fancybox-overlay").css("width",$(document).width()).css("height",$(document).height());d=$(window).height();$(this).scrollTop()==
	0||$("#fancybox-overlay").is(":visible")?b?$("#top").hide():$("#top").fadeOut(300):b?($("#top").css("top",$(this).scrollTop()+d-220+"px").show(),$("#floatCart").css("top",$(this).scrollTop()+d-380+"px")):$("#top").fadeIn(300)})}function d(b,d){if(!b){var j=($(document).width()-f-30)*0.5-d;$("#top").css("right",j+"px");$("#floatCart").css("right",j+"px");$("#floatCart").show()}$(window).resize(function(){$("#fancybox-overlay").css("width",$(document).width()).css("height",$(document).height());if(b){var j=
	$(window).height();$("#top").css("top",$(this).scrollTop()+j-220+"px");$("#floatCart").css("top",$(this).scrollTop()+j-380+"px")}else j=($(document).width()-f-30)*0.5-d,$(window).width()<=h?($("#top").css("right","0px"),$("#floatCart").css("right","0px")):($("#top").css("right",j+"px"),$("#floatCart").css("right",j+"px"))})}var f=1180,h=f+80,j=$("#tradeCount").text();$("em.cart_total").text(j);navigator.userAgent.search("MSIE 6")>-1?(d(!0),b(!0)):(navigator.userAgent.search("MSIE 8")>-1?d(!1,36):
	navigator.userAgent.search("MSIE 9")>-1||navigator.userAgent.search("MSIE 10")>-1?d(!1,34):navigator.userAgent.search("Opera")>-1?d(!1,24):d(!1,25),b(!1));$("#top").click(function(){$(document).scrollTop(0);if(navigator.userAgent.search("MSIE 6")>-1){var b=$(window).height();$("#floatCart").css("top",b-380+"px")}return!1})}